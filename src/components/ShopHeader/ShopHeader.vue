...
<template>
  <div class="shop-header">
    ...
    <!-- 点击触发 toggleShopShow,改变shopShow值，触发显示隐藏-->
    ...
    <!-- 点击触发 toggleSupportShow,改变supportShow值，触发显示隐藏-->
    <!-- v-if="info.supports" 当数据传过去的时候再显示，这里要控制一下，否则报错；这里是三层数据：{}.a=undefined;{}.a.b=undefined.b报错 -->
      ...
      <div class="shop-brief-modal" v-show="shopShow">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="toggleShopShow">
            <span class="iconfont icon-close icon-close"></span>
          </div>
        </div>
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="supportShow">
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <!-- :class="supportClasses[support.type]"  动态class,控制样式，有三个是一样的 -->
